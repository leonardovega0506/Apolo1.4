...
@Component({
  selector: 'app-lista-registro-recibo',
  templateUrl: './lista-registro-recibo.component.html',
  styleUrls: ['./lista-registro-recibo.component.css']
})
export class ListaRegistroReciboComponent {
  //Atributos
    ...
    this.rellenarRegistros(this.pageActual, value, 'idRegistro', 'asc', this.filtroRegistros);
      ...
      generarAccion(idRegistro: any) {
        this.andService.generarTiempoReciboL(idRegistro).subscribe(
          (data) => {
            Swal.fire("Exito","Exito al generar accion","success");
            this.modal.dismissAll();
            this.ngOnInit();
          },
          (error) => {
  ...
  redirigirOrden(idCompra){
    this.router.navigate(["/compras/ordenes/"+idCompra]);
    this.modal.dismissAll();
  }
    ...
    generarAccionTransito(idRegistro: any) {
      if(this.vMaquila){
        this.andService.generarTiempoTransito(idRegistro,"si").subscribe(
          (data) => {
            this.ngOnInit()
            this.modal.dismissAll();
            Swal.fire("Exito","Exito al generar la accion","success");
        ...
        this.andService.generarTiempoTransito(idRegistro,"no").subscribe(
          (data) => {
            this.ngOnInit()
            this.modal.dismissAll();
            Swal.fire("Exito","Exito al generar la accion","success");
    ...
    generarAccionEspecial(idRegistro:any){
        this.andService.generarTiempoEspecial(idRegistro).subscribe(
          (data)=>{
            this.ngOnInit()
            this.modal.dismissAll();
            Swal.fire("Exito","Exito al generar la accion","success");
